...
var file_compass_heading_proto_goTypes = []interface{}{
...
func file_compass_heading_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_compass_heading_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CompassHeading); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
