...
// 	protoc        v6.33.2
// source: sixafter/types/geofence.proto
...
func (x *Geofence) Reset() {
	*x = Geofence{}
	mi := &file_sixafter_types_geofence_proto_msgTypes[0]
...
func (*Geofence) Descriptor() ([]byte, []int) {
	return file_sixafter_types_geofence_proto_rawDescGZIP(), []int{0}
}
...
var File_sixafter_types_geofence_proto protoreflect.FileDescriptor

const file_sixafter_types_geofence_proto_rawDesc = "" +
	"\n" +
...
var (
	...
	file_sixafter_types_geofence_proto_rawDescData []byte
)

func file_sixafter_types_geofence_proto_rawDescGZIP() []byte {
	file_sixafter_types_geofence_proto_rawDescOnce.Do(func() {
		file_sixafter_types_geofence_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_sixafter_types_geofence_proto_rawDesc), len(file_sixafter_types_geofence_proto_rawDesc)))
	})
	return file_sixafter_types_geofence_proto_rawDescData
}

var file_sixafter_types_geofence_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_sixafter_types_geofence_proto_goTypes = []any{
	(*Geofence)(nil),   // 0: sixafter.types.Geofence
	(*MapPolygon)(nil), // 1: sixafter.types.MapPolygon
}
var file_sixafter_types_geofence_proto_depIdxs = []int32{
...
func init() { file_sixafter_types_geofence_proto_init() }
func file_sixafter_types_geofence_proto_init() {
	if File_sixafter_types_geofence_proto != nil {
		return
	}
	file_sixafter_types_map_polygon_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_sixafter_types_geofence_proto_goTypes,
		DependencyIndexes: file_sixafter_types_geofence_proto_depIdxs,
		MessageInfos:      file_sixafter_types_geofence_proto_msgTypes,
	}.Build()
	File_sixafter_types_geofence_proto = out.File
	file_sixafter_types_geofence_proto_goTypes = nil
	file_sixafter_types_geofence_proto_depIdxs = nil
}
