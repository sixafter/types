...
// 	protoc        v6.33.1
// source: sixafter/types/country.proto
...
func (x *Country) Reset() {
	*x = Country{}
	mi := &file_sixafter_types_country_proto_msgTypes[0]
...
func (*Country) Descriptor() ([]byte, []int) {
	return file_sixafter_types_country_proto_rawDescGZIP(), []int{0}
}
...
var File_sixafter_types_country_proto protoreflect.FileDescriptor

const file_sixafter_types_country_proto_rawDesc = "" +
	"\n" +
...
var (
	...
	file_sixafter_types_country_proto_rawDescData []byte
)

func file_sixafter_types_country_proto_rawDescGZIP() []byte {
	file_sixafter_types_country_proto_rawDescOnce.Do(func() {
		file_sixafter_types_country_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_sixafter_types_country_proto_rawDesc), len(file_sixafter_types_country_proto_rawDesc)))
	})
	return file_sixafter_types_country_proto_rawDescData
}

var file_sixafter_types_country_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_sixafter_types_country_proto_goTypes = []any{
	(*Country)(nil), // 0: sixafter.types.Country
}
var file_sixafter_types_country_proto_depIdxs = []int32{
...
func init() { file_sixafter_types_country_proto_init() }
func file_sixafter_types_country_proto_init() {
	if File_sixafter_types_country_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_sixafter_types_country_proto_rawDesc), len(file_sixafter_types_country_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_sixafter_types_country_proto_goTypes,
		DependencyIndexes: file_sixafter_types_country_proto_depIdxs,
		MessageInfos:      file_sixafter_types_country_proto_msgTypes,
	}.Build()
	File_sixafter_types_country_proto = out.File
	file_sixafter_types_country_proto_goTypes = nil
	file_sixafter_types_country_proto_depIdxs = nil
}
