...
// 	protoc        v6.33.2
// source: sixafter/types/geospatial_elevation.proto
...
func (GeospatialElevation_GeodeticDatum) Descriptor() protoreflect.EnumDescriptor {
	return file_sixafter_types_geospatial_elevation_proto_enumTypes[0].Descriptor()
}

func (GeospatialElevation_GeodeticDatum) Type() protoreflect.EnumType {
	return &file_sixafter_types_geospatial_elevation_proto_enumTypes[0]
}
...
func (GeospatialElevation_GeodeticDatum) EnumDescriptor() ([]byte, []int) {
	return file_sixafter_types_geospatial_elevation_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *GeospatialElevation) Reset() {
	*x = GeospatialElevation{}
	mi := &file_sixafter_types_geospatial_elevation_proto_msgTypes[0]
...
func (*GeospatialElevation) Descriptor() ([]byte, []int) {
	return file_sixafter_types_geospatial_elevation_proto_rawDescGZIP(), []int{0}
}
...
var File_sixafter_types_geospatial_elevation_proto protoreflect.FileDescriptor
...
const file_sixafter_types_geospatial_elevation_proto_rawDesc = "" +
	...
	"\x12com.sixafter.typesB\x18GeospatialElevationProtoP\x01Z.github.com/sixafter/types/sixafter/types;types\xf8\x01\x01\xa2\x02\x03TPB\xaa\x02\x1dSixAfter.Types.WellKnownTypesb\x06proto3"

var (
	file_sixafter_types_geospatial_elevation_proto_rawDescOnce sync.Once
	file_sixafter_types_geospatial_elevation_proto_rawDescData []byte
)

func file_sixafter_types_geospatial_elevation_proto_rawDescGZIP() []byte {
	file_sixafter_types_geospatial_elevation_proto_rawDescOnce.Do(func() {
		file_sixafter_types_geospatial_elevation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_sixafter_types_geospatial_elevation_proto_rawDesc), len(file_sixafter_types_geospatial_elevation_proto_rawDesc)))
	})
	return file_sixafter_types_geospatial_elevation_proto_rawDescData
}

var file_sixafter_types_geospatial_elevation_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_sixafter_types_geospatial_elevation_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_sixafter_types_geospatial_elevation_proto_goTypes = []any{
...
var file_sixafter_types_geospatial_elevation_proto_depIdxs = []int32{
...
func init() { file_sixafter_types_geospatial_elevation_proto_init() }
func file_sixafter_types_geospatial_elevation_proto_init() {
	if File_sixafter_types_geospatial_elevation_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_sixafter_types_geospatial_elevation_proto_rawDesc), len(file_sixafter_types_geospatial_elevation_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_sixafter_types_geospatial_elevation_proto_goTypes,
		...
		MessageInfos:      file_sixafter_types_geospatial_elevation_proto_msgTypes,
	}.Build()
	File_sixafter_types_geospatial_elevation_proto = out.File
	file_sixafter_types_geospatial_elevation_proto_goTypes = nil
	file_sixafter_types_geospatial_elevation_proto_depIdxs = nil
}
