...
// 	protoc        v6.33.1
// source: sixafter/types/compass_heading.proto
...
func (x *CompassHeading) Reset() {
	*x = CompassHeading{}
	mi := &file_sixafter_types_compass_heading_proto_msgTypes[0]
...
func (*CompassHeading) Descriptor() ([]byte, []int) {
	return file_sixafter_types_compass_heading_proto_rawDescGZIP(), []int{0}
}
...
var File_sixafter_types_compass_heading_proto protoreflect.FileDescriptor

const file_sixafter_types_compass_heading_proto_rawDesc = "" +
	"\n" +
	...
	"\x12com.sixafter.typesB\x13CompassHeadingProtoP\x01Z.github.com/sixafter/types/sixafter/types;types\xf8\x01\x01\xa2\x02\x03TPB\xaa\x02\x1dSixAfter.Types.WellKnownTypesb\x06proto3"

var (
	file_sixafter_types_compass_heading_proto_rawDescOnce sync.Once
	file_sixafter_types_compass_heading_proto_rawDescData []byte
)

func file_sixafter_types_compass_heading_proto_rawDescGZIP() []byte {
	file_sixafter_types_compass_heading_proto_rawDescOnce.Do(func() {
		file_sixafter_types_compass_heading_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_sixafter_types_compass_heading_proto_rawDesc), len(file_sixafter_types_compass_heading_proto_rawDesc)))
	})
	return file_sixafter_types_compass_heading_proto_rawDescData
}

var file_sixafter_types_compass_heading_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_sixafter_types_compass_heading_proto_goTypes = []any{
	(*CompassHeading)(nil),        // 0: sixafter.types.CompassHeading
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_sixafter_types_compass_heading_proto_depIdxs = []int32{
...
func init() { file_sixafter_types_compass_heading_proto_init() }
func file_sixafter_types_compass_heading_proto_init() {
	if File_sixafter_types_compass_heading_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_sixafter_types_compass_heading_proto_rawDesc), len(file_sixafter_types_compass_heading_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		...
		DependencyIndexes: file_sixafter_types_compass_heading_proto_depIdxs,
		MessageInfos:      file_sixafter_types_compass_heading_proto_msgTypes,
	}.Build()
	File_sixafter_types_compass_heading_proto = out.File
	file_sixafter_types_compass_heading_proto_goTypes = nil
	file_sixafter_types_compass_heading_proto_depIdxs = nil
}
