...
// 	protoc        v6.33.2
// source: sixafter/types/time_zone.proto
...
func (x *TimeZone) Reset() {
	*x = TimeZone{}
	mi := &file_sixafter_types_time_zone_proto_msgTypes[0]
...
func (*TimeZone) Descriptor() ([]byte, []int) {
	return file_sixafter_types_time_zone_proto_rawDescGZIP(), []int{0}
}
...
func (x *TimeZone_TimeOffset) Reset() {
	*x = TimeZone_TimeOffset{}
	mi := &file_sixafter_types_time_zone_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TimeZone_TimeOffset) Descriptor() ([]byte, []int) {
	return file_sixafter_types_time_zone_proto_rawDescGZIP(), []int{0, 0}
}
...
var File_sixafter_types_time_zone_proto protoreflect.FileDescriptor

const file_sixafter_types_time_zone_proto_rawDesc = "" +
	"\n" +
...
var (
	...
	file_sixafter_types_time_zone_proto_rawDescData []byte
)

func file_sixafter_types_time_zone_proto_rawDescGZIP() []byte {
	file_sixafter_types_time_zone_proto_rawDescOnce.Do(func() {
		file_sixafter_types_time_zone_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_sixafter_types_time_zone_proto_rawDesc), len(file_sixafter_types_time_zone_proto_rawDesc)))
	})
	return file_sixafter_types_time_zone_proto_rawDescData
}

var file_sixafter_types_time_zone_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_sixafter_types_time_zone_proto_goTypes = []any{
...
var file_sixafter_types_time_zone_proto_depIdxs = []int32{
...
func init() { file_sixafter_types_time_zone_proto_init() }
func file_sixafter_types_time_zone_proto_init() {
	if File_sixafter_types_time_zone_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_sixafter_types_time_zone_proto_goTypes,
		DependencyIndexes: file_sixafter_types_time_zone_proto_depIdxs,
		MessageInfos:      file_sixafter_types_time_zone_proto_msgTypes,
	}.Build()
	File_sixafter_types_time_zone_proto = out.File
	file_sixafter_types_time_zone_proto_goTypes = nil
	file_sixafter_types_time_zone_proto_depIdxs = nil
}
