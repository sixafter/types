...
// Represents a geospatial, or global positioning satelite (GPS), coordinate.
...
func (x *GeospatialCoordinate) GetLatitude() float32 {
	if x != nil {
		return x.Latitude
	}
	return 0
...
func (x *GeospatialCoordinate) GetLongitude() float32 {
	if x != nil {
		return x.Longitude
	}
	return 0
